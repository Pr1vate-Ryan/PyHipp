...
#SBATCH -J "rplspl4a"   # job name
#SBATCH -o rplspl4a-slurm.%N.%j.out # STDOUT
#SBATCH -e rplspl4a-slurm.%N.%j.err # STDERR
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:057704056662:awsnotify --message "RPLSplitJobDone array04"
